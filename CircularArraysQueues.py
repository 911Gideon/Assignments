class CIRCULARARRAYQUEUE:
    ...
    def __init__(self):
        ...
        - _data: a list filled with None
        - _size: number of actual elements
    ...
    def enqueue(self, element):
        ...
        Use modulo arithmetic to calculate the correct back position.
        """
    ...
    def _resize(self, new_capacity):
        """
        Resize to a new capacity and rearrange elements linearly from front.
        """
        old_data = self._data
